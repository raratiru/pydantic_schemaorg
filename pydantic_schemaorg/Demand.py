...
class Demand(Intangible):
    ...
    itemOffered: Optional[Union[List[Union['Trip', 'CreativeWork', 'AggregateOffer', 'MenuItem', 'Event', 'Service', 'Product', str]], 'Trip', 'CreativeWork', 'AggregateOffer', 'MenuItem', 'Event', 'Service', 'Product', str]] = Field(
        default=None,
