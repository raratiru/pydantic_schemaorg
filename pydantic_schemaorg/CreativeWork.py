...
class CreativeWork(Thing):
    ...
    interpretedAsClaim: Optional[
        Union[List[Union["Claim", str]], "Claim", str]
    ] = Field(
        default=None,
    ...
    accountablePerson: Optional[
        Union[List[Union["Person", str]], "Person", str]
    ] = Field(
        default=None,
